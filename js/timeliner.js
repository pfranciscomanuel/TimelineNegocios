...
; (function ($) {
    ...
    function startTimeliner(options) {
        var settings = {
            ...
            expandAllText: options['expandAllText'] || '+ Mostrar todo',
            // sets the text of the expandAll selector after the timeline is fully collapsed
            // value: string
            // default: + Mostrar todo

            collapseAllText: options['collapseAllText'] || '- Ocultar todo'
        ...
        if ($(settings.timelineContainer).data('started')) {
            ...
            $(settings.timelineContainer).on("click", settings.timelineSectionMarker, function () {
                ...
                if (numEvents > numOpen) {
                    // if there are more events available than are displayed, then fully Mostrar todo events below MajorMarker
